...
def usage():
	print ('sandum51 DDoS Tool ( individual Dangerous Denial of Service )')
	print ('New loaded Botnets: 1,798,445,657')
	print ('Example: main.py http://nasa.gov')
print ("""
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
			print ("----->>> I am sandum51 join me on the journey to get power <<<-----")
			code=500
